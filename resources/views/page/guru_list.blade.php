            ...
            <div class="col-lg-12 mb-4 order-0">
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h5 class="card-title text-primary">Daftar Guru Lembaga {{auth()->user()->username}}</h5>
                                <p class="mb-4">
                                ...
                                <ul>
                                    ...
                                    <li>Atau anda dapat menambahkan beberapa guru sekaligus dengan mengunduh template Guru, Kemudian mengimportkannya kembali dengan mengisi data yang sesuai dengan template.</li>
                                </ul>
            ...
            <div class="col-lg-12 mb-4 order-0">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <a href="/create-new-guru" class="btn btn-success mb-2" style="margin-bottom: 20px; width: 100%"> Tambah Guru</a>
                            </div>
                            <div class="col-md-4">
                                <a href="/export-template-guru" class="btn btn-info mb-2" style="margin-bottom: 20px;width: 100%"> Unduh Template Guru</a>
                            </div>
                            <div class="col-md-4">
                                <a href="#" class="btn btn-primary mb-2" style="margin-bottom: 20px;width: 100%" data-toggle="modal" data-target="#modalimport"> Import Data Guru</a>
                            </div>
                        </div>
                    </div>
                </div>
