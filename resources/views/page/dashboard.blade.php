                                ...
                                <div class="card-body">
                                    <div class="card-title d-flex align-items-start justify-content-between">
                                        <div class="avatar flex-shrink-0">
                                            <img src="{{asset('assets/img/icons/unicons/santri.png')}}" alt="chart success"
                                            class="rounded" />
                                        </div>
                                        <div class="dropdown">
                        ...
                        <div class="row row-bordered g-0">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="d-flex px-xxl-4 px-lg-2 p-4 gap-xxl-3 gap-lg-1 gap-3 justify-content-between">
                                    <div class="d-flex">
                                        <div class="me-2">
                                            <span class="badge bg-label-primary p-2"><img src="{{asset('assets/img/icons/unicons/total.png')}}" alt="chart success"
                                                class="rounded" style="width: 25px" /></span>
                                        </div>
                                    ...
                                    <div class="d-flex">
                                        <div class="me-2">
                                            <span class="badge bg-label-info p-2"><img src="{{asset('assets/img/icons/unicons/total.png')}}" alt="chart success"
                                                class="rounded" style="width: 25px" /></span>
                                        </div>
                                        <div class="d-flex flex-column">
                                            <small>{{date('Y')}}</small>
                                ...
                                <ul class="p-0 m-0">
                                    <li class="d-flex mb-4 pb-1">
                                        <div class="avatar flex-shrink-0 me-3">
                                            <span class="avatar-initial rounded bg-label-primary"><img src="{{asset('assets/img/icons/unicons/anak.png')}}" alt="chart success"
                                                class="rounded" style="width: 35px"/></span>
                                        </div>
                                    ...
                                    <li class="d-flex mb-4 pb-1">
                                        <div class="avatar flex-shrink-0 me-3">
                                            <span class="avatar-initial rounded bg-label-success"><img src="{{asset('assets/img/icons/unicons/remaja.png')}}" alt="chart success"
                                                class="rounded" style="width: 45px"/></span>
                                        </div>
                                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                            <div class="me-2">
                                    ...
                                    <li class="d-flex">
                                        <div class="avatar flex-shrink-0 me-3">
                                            <span class="avatar-initial rounded bg-label-info"><img src="{{asset('assets/img/icons/unicons/dewasa.png')}}" alt="chart success"
                                                class="rounded" style="width: 45px"/></span>
                                        </div>
                                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                            <div class="me-2">
            ...
            $(document).ready(function () { 
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        ...
                        colors: [config.colors.success, config.colors.info, config.colors.primary, config.colors.secondary],
                        stroke: {
                            width: 5,
                            colors: cardColor
                        },
